...
@NamedQuery(name="MidyearPopulationAgeSex.findAll", query="SELECT m FROM MidyearPopulationAgeSex m")
public class MidyearPopulationAgeSex implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MidyearPopulationAgeSexPK id;
	...
	public MidyearPopulationAgeSexPK getId() {
		return this.id;
	}

	public void setId(MidyearPopulationAgeSexPK id) {
		this.id = id;
	}
