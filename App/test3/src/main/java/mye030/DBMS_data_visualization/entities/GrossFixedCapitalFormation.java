...
/**
 * The persistent class for the gross_fixed_capital_formation database table.
 * 
 */
@Entity
@Table(name="gross_fixed_capital_formation")
@NamedQuery(name="GrossFixedCapitalFormation.findAll", query="SELECT g FROM GrossFixedCapitalFormation g")
public class GrossFixedCapitalFormation implements Serializable {
