...
/**
 * The persistent class for the gdp_total database table.
 * 
 */
@Entity
@Table(name="gdp_total")
@NamedQuery(name="GdpTotal.findAll", query="SELECT g FROM GdpTotal g")
public class GdpTotal implements Serializable {
