...
/**
 * The persistent class for the labour_share_of_gdp database table.
 * 
 */
@Entity
@Table(name="labour_share_of_gdp")
@NamedQuery(name="LabourShareOfGdp.findAll", query="SELECT l FROM LabourShareOfGdp l")
public class LabourShareOfGdp implements Serializable {
