...
/**
 * The persistent class for the estimated_gni_male database table.
 * 
 */
@Entity
@Table(name="estimated_gni_male")
@NamedQuery(name="EstimatedGniMale.findAll", query="SELECT e FROM EstimatedGniMale e")
public class EstimatedGniMale implements Serializable {
