...
/**
 * The persistent class for the gni_per_capita database table.
 * 
 */
@Entity
@Table(name="gni_per_capita")
@NamedQuery(name="GniPerCapita.findAll", query="SELECT g FROM GniPerCapita g")
public class GniPerCapita implements Serializable {
