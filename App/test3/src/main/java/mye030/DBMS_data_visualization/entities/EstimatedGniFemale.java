...
/**
 * The persistent class for the estimated_gni_female database table.
 * 
 */
@Entity
@Table(name="estimated_gni_female")
@NamedQuery(name="EstimatedGniFemale.findAll", query="SELECT e FROM EstimatedGniFemale e")
public class EstimatedGniFemale implements Serializable {
